...
In additon to formal and internal roles that have been previously described in detail [here](https://momenehforoutan.github.io/RLadiesMelbInc_2019/), we introduced the notion of "advisory board" members. We were pleased to have two of our previous members [Momeneh Foroutan](https://twitter.com/S_Foroutan) and [Göknur Giner](https://twitter.com/goknurginer) as our first advisory board members. Both of them are the founders of the R-Ladies Melbourne chapter, hence both have a very rich understanding and experience about how the groups work and are a continuing source of invaluable suggestions. Since we established this new role, we also formally defined what the requirements are to be part of the advisory board, their responsibilities, participation requirements and the maximum total number of members allowed to be on the board at the same time.
...
# Acknowledgements
I would like to thank [Marie](https://twitter.com/MTrussart), [Shazia](https://twitter.com/DrShaziaRuybal), [Sepideh](https://twitter.com/S_Foroutan) and [Anna](https://twitter.com/annaquagli) for their valuable feedback about on this report.
